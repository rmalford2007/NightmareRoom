function UnityProgress (dom) {
	...
	logoImage.src = "https://rawgit.com/rmalford2007/NightmareRoom/master/Builds/RoomOfShadows_Web/TemplateData/Logo." + splashStyle + ".png";
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "https://rawgit.com/rmalford2007/NightmareRoom/master/Builds/RoomOfShadows_Web/TemplateData/ProgressFrame." + splashStyle + ".png";
	...
	progressBarImg.src = "https://rawgit.com/rmalford2007/NightmareRoom/master/Builds/RoomOfShadows_Web/TemplateData/ProgressBar." + splashStyle + ".png";
